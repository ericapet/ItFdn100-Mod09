...
# Erica Peterson, 9.7.22, Added code to make script run without errors and changed grammar
# ---------------------------------------------------------- #
...
class Person(object):
    ...
    def first_name(self, value):
        if not str(value).isnumeric():
            ...
            raise Exception("Names cannot be numerical")
...
class Employee(Person):
    ...
    def employee_id(self, value):
        if str(value).isnumeric():
            ...
            raise Exception("IDs must be numerical")
